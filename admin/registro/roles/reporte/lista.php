...
//Cabecera de página
		...
		function Header() {
				...
				$this->Text(100, 54, 'REGISTRO DE ROLES');
...
$pdf -> SetY(60);
$header = array('CODIGO', 'ROL', 'DETALLE');

$pdf -> SetX(10);
$pdf->TablaColores($header);

$select = $pdo->query("SELECT * FROM hel_rol");
...
while ($row = $select->fetch()) {
		...
		$pdf->Cell(30, 6.5, $row["cod_rol"], 1, 'E');
		$pdf->Cell(80, 6.5, $row['nom_rol'], 1, 'E');
		$pdf->Cell(170, 6.5, $row['det_rol'], 1, 'E');
		$pdf->Ln();
}
$pdf->Ln();
