...
$select = $pdo->query("SELECT * FROM vista_rol_empleado");
?>
  ...
  <table class="mui-table mui-table--bordered" id="table-data">
    ...
    <tbody>
      ...
      if($select->rowCount() == 0){
        echo "<tr><td colspan='4' class='text-center'>No hay empleado con roles registrados</td></tr>   <script>
           if( isMobile.any() ) {
