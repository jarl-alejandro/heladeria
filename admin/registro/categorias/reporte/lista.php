...
//Cabecera de página
		...
		function Header() {
				...
				$this->Text(100, 54, 'REGISTRO DE CATEGORIAS');
...
$pdf -> SetY(60);
$header = array('CODIGO', 'CATEGORIA', 'DETALLE');
...
while ($row = $select->fetch()) {
		...
		$pdf->Cell(30, 6.5, $row["cod_cate"], 1, 'E');
		$pdf->Cell(80, 6.5, $row['nom_cate'], 1, 'E');
		$pdf->Cell(170, 6.5, $row['det_cate'], 1, 'E');
		$pdf->Ln();
}
$pdf->Ln();
