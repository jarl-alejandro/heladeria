...
$pdf -> SetY(60);
$header = array('CEDULA', 'PROVEEDOR', 'E-MAIL', 'DIRECCION');

$pdf -> SetX(10);
$pdf->TablaColores($header);

$select = $pdo->query("SELECT * FROM hel_prove");
...
while ($row = $select->fetch()) {
		...
		$pdf->Cell(90, 6.5,  $row["nom_prove"], 1, 'E');
		$pdf->Cell(80, 6.5, $row['ema_prove'], 1, 'E');
		$pdf->Cell(80, 6.5, $row['dir_prove'], 1, 'E');
		$pdf->Ln();
}
$pdf->Ln();
