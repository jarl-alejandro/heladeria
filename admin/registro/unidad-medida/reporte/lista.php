...
//Cabecera de página
		...
		function Header() {
				...
				$this->Text(100, 54, 'REGISTRO DE UNIDAD DE SERVICIO');
...
$pdf -> SetY(60);
$header = array('CODIGO', 'UNIDAD', 'EQUIVALENCIA');
...
while ($row = $select->fetch()) {
		...
		$pdf->Cell(30, 6.5, $row["cod_uni"], 1, 'E');
		$pdf->Cell(80, 6.5, $row['nom_uni'], 1, 'E');
		$pdf->Cell(170, 6.5, $row['equi_uni'], 1, 'E');
		$pdf->Ln();
}
$pdf->Ln();
