				...
				<div class="navbar-collapse collapse ">
					<ul id="menu-top" class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li class="dropdown-submenu">
                  <a href="../../../admin/movimiento/pedidos" tabindex="0">Pedidos</a>
                </li>
								<li class="dropdown-submenu"> <a tabindex="0">Facturacion</a></li>
								<li class="dropdown-submenu"> <a tabindex="0" href="../../../admin/movimiento/carta-menu">Carta Menu</a></li>
						...
						<li class="dropdown">
							<a tabindex="0" data-toggle="dropdown" data-submenu="" aria-expanded="false">Estadistica<span class="caret"></span></a>
							<ul class="dropdown-menu">
